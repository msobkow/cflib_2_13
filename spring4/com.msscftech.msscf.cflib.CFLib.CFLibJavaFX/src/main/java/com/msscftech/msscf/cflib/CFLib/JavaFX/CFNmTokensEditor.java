...
extends CFTextField
{
	...
	public void setNmTokensValue( String value ) {
		if( value != null ) {
			setText( value );
		}
		else {
	...
	public String getNmTokensValue() {
		final String S_ProcName = "getNmTokensValue";
		String text = getText();
		if( text == null ) {
			return( null );
		}
