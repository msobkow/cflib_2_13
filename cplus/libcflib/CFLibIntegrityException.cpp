...
namespace cflib {
	...
	const std::string CFLibIntegrityException::CLASS_NAME( "CFLibIntegrityException" );
	const std::string CFLibIntegrityException::CAUSE_NAME( "Integrity" );

	CFLibIntegrityException::~CFLibIntegrityException() {
	}

	CFLibIntegrityException::CFLibIntegrityException(
		const CFLibIntegrityException& src )
