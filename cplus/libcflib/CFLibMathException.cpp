...
namespace cflib {
	...
	const std::string CFLibMathException::CLASS_NAME( "CFLibMathException" );
	const std::string CFLibMathException::CAUSE_NAME( "Math" );

	CFLibMathException::~CFLibMathException() {
	}

	CFLibMathException::CFLibMathException(
		const CFLibMathException& src )
