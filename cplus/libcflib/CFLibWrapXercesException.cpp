...
namespace cflib {
	...
	const std::string CFLibWrapXercesException::CLASS_NAME( "CFLibWrapXercesException" );
	const std::string CFLibWrapXercesException::CAUSE_NAME( "XercesException" );

	CFLibWrapXercesException::~CFLibWrapXercesException() {
	}

	CFLibWrapXercesException::CFLibWrapXercesException(
		const CFLibWrapXercesException& src )
	...
	: cflib::CFLibRuntimeException(
			...
			S_Empty,					// argArgMinValueString
			S_Empty,					// argArgMaxValueString
			"Caught Xerces exception " + caughtExceptionName + " - " + caughtWhat )		// argMessageText
	{
	}
}
