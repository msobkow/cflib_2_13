...
namespace cflib {
	...
	const std::string CFLibEmptyArgumentException::CLASS_NAME( "CFLibEmptyArgumentException" );
	const std::string CFLibEmptyArgumentException::CAUSE_NAME( "Empty" );
	...
	: cflib::CFLibArgumentException(
			...
			S_Empty,					// argArgMinValueString
			S_Empty,					// argArgMaxValueString
			S_IS_NULL_OR_EMPTY )		// argMessageText
	{
	}
}
