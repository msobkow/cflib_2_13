...
namespace cflib {
	...
	const std::string CFLibSubroutineException::CLASS_NAME( "CFLibSubroutineException" );
	const std::string CFLibSubroutineException::CAUSE_NAME( "Subroutine" );
	...
	: cflib::CFLibRuntimeException(
			...
			S_Empty,					// argArgMinValueString
			S_Empty,					// argArgMaxValueString
			std::string( CFLib::S_SUBROUTINE + subName + CFLib::S_RETURNED + std::to_string( subStatus ) + CFLib::S_COMMASPACE + msg ) )
	{
	}
}
