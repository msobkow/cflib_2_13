...
namespace cflib {
	...
	const std::string CFLibUsageException::CLASS_NAME( "CFLibUsageException" );
	const std::string CFLibUsageException::CAUSE_NAME( "Usage" );
	...
	: cflib::CFLibCodeStateException(
			...
			S_Empty,					// argArgMinValueString
			S_Empty,					// argArgMaxValueString
			S_INVALID_USAGE )			// argMessageText
	{
	}
