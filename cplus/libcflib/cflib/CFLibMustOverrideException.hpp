...
namespace cflib {
	...
	class CFLibMustOverrideException : public CFLibCodeStateException {

	public:
		static const std::string CLASS_NAME;
		static const std::string CAUSE_NAME;
		static const std::string S_MUST_OVERRIDE;

		virtual ~CFLibMustOverrideException();

		CFLibMustOverrideException(
