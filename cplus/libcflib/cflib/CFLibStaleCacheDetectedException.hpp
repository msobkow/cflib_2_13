...
namespace cflib {
	...
	class CFLibStaleCacheDetectedException : public CFLibRuntimeException {

	public:
		static const std::string CLASS_NAME;
		static const std::string CAUSE_NAME;
		static const std::string S_STALE_CACHE_DETECTED;

		virtual ~CFLibStaleCacheDetectedException();

		CFLibStaleCacheDetectedException(
