...
namespace cflib {
	...
	class CFLibUnsupportedClassException : public CFLibIntegrityException {

	public:
		static const std::string CLASS_NAME;
		static const std::string CAUSE_NAME;
		static const std::string S_UNSUPPORTED_CLASS;
		static const std::string S_EXPECTED;

		virtual ~CFLibUnsupportedClassException();

		CFLibUnsupportedClassException(
