...
namespace cflib {
	...
	class CFLibEmptyArgumentException : public CFLibArgumentException {

	public:
		static const std::string CLASS_NAME;
		static const std::string CAUSE_NAME;
		static const std::string S_IS_NULL_OR_EMPTY;

		virtual ~CFLibEmptyArgumentException();

		CFLibEmptyArgumentException(
