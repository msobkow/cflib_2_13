...
namespace cflib {
	...
	class CFLibNotImplementedYetException : public CFLibCodeStateException {

	public:
		static const std::string CLASS_NAME;
		static const std::string CAUSE_NAME;
		static const std::string S_NOT_IMPLEMENTED_YET;

		virtual ~CFLibNotImplementedYetException();

		CFLibNotImplementedYetException(
