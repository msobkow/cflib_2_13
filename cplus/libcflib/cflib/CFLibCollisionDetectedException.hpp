...
namespace cflib {
	...
	class CFLibCollisionDetectedException : public CFLibRuntimeException {

	public:
		static const std::string CLASS_NAME;
		static const std::string CAUSE_NAME;
		static const std::string S_COLLISION_DETECTED;

		virtual ~CFLibCollisionDetectedException();

		CFLibCollisionDetectedException(
