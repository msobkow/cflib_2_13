...
namespace cflib {
	...
	class CFLibNullArgumentException : public CFLibArgumentException {

	public:
		static const std::string CLASS_NAME;
		static const std::string CAUSE_NAME;
		static const std::string S_IS_NULL;

		virtual ~CFLibNullArgumentException();

		CFLibNullArgumentException(
