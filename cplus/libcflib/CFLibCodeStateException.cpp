...
namespace cflib {
	...
	const std::string CFLibCodeStateException::CLASS_NAME( "CFLibCodeStateException" );
	const std::string CFLibCodeStateException::CAUSE_NAME( "CodeState" );

	CFLibCodeStateException::~CFLibCodeStateException() {
	}

	CFLibCodeStateException::CFLibCodeStateException(
		const CFLibCodeStateException& src )
