...
namespace cflib {
	...
	const std::string CFLibArgumentException::CLASS_NAME( "CFLibArgumentException" );
	const std::string CFLibArgumentException::CAUSE_NAME( "Argument" );

	CFLibArgumentException::~CFLibArgumentException() {
	}

	CFLibArgumentException::CFLibArgumentException(
		const CFLibArgumentException& src )
